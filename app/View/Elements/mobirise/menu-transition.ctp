            ...
            <ul class="navbar-nav nav-dropdown" data-app-modern-menu="true">
                <li class="nav-item pull-left">
                    ...
                    <?php if($lang != null && $lang == 'en'):?>
                        <?php echo $this->Html->link($this->Html->image('Spain.png').'&nbsp;'.'Español', $lang_changed_url, array('class' => 'nav-link link text-white display-4', 'title'=>'Traducir al Español', 'escape'=>false)) ?>
                    <?php else:?>
