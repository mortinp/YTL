...
<?php echo $this->Form->create('User', array('id' => 'CDirectForm', 'url' => array('controller' => 'users',  'action'=>'contact_driver'))); ?>
    ...
    if(isset($discount_id)){
        echo $this->Form->input('DriverTravel.discount_id', array('type' =>'hidden', 'value'=>$discount_id));
        echo $this->Form->input('DriverTravel.notification_type', array('type' => 'hidden', 'value' => DriverTravel::$NOTIFICATION_TYPE_DISCOUNT));
    }
    else 
