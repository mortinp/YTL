...
<div class="panel panel-info control-panel control-panel-in">
            ...
            <div style="width: 200px">
                ...
                <div class="btn-wrapper">
                    ...
                    <?php if($data['DriverTravel']['driver_traveler_conversation_count'] > 0):?>
                        <span class="label label-primary" title="Total de mensajes"><?php echo $data['DriverTravel']['driver_traveler_conversation_count']?></span>
                    <?php endif?>
                    ...
                    <?php if($unreadMessages != 0):?>
                        <span class="label label-success" style="margin-left:5px" title="Mensajes nuevos">+<?php echo $unreadMessages?></span>
