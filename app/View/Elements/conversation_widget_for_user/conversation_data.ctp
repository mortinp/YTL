...
<div>
    ...
    <?php echo $this->Html->link(__('Ver conversación con %s', $conversation['Driver']['DriverProfile']['driver_name'] ), array('controller'=>'conversations', 'action'=>'messages/'.$thread['id']));?>
