...
<div id="front-page-bg">
    ...
    <div class="col-md-8 col-md-offset-2 value-proposition" style="margin-top: 20px">
        ...
        <br/>
        <h2>
            <b><?php echo __d('homepage', 'Contacta %s choferes que operan en la isla y recibe ofertas directamente de ellos', __('tres')) ?></b>
        </h2>
        <hr/>
        <h3>
            <?php echo __d('homepage', 'Envíales tu solicitud, habla con ellos y contrata al que creas mejor') ?>
        </h3>
        <div class="sell-button" style="padding-top:30px">
            <a href="#!" class="btn btn-success show-travel-form">
                ...
                <div class="sub">
                    <?php echo __d('homepage', 'Acuerda un taxi para tus traslados en Cuba') ?>
                </div>
            </a>
        </div>
    </div>
...
<div class="featurette-container arrow_box arrow_box_bottom">
    ...
    <div class="row featurette">
        ...
        <div class="col-md-7">
            ...
            <p><?php echo $this->Html->link('<big><big>'.__d('homepage', 'Mira testimonios sobre nuestros choferes').' »</big></big>', array('controller'=>'testimonials', 'action'=>'featured'), array('class'=>'btn btn-warning', 'escape'=>false))?></p>
        </div>
    </div>
