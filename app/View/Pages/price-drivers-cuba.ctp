...
<div id="front-page-bg">
    ...
    <div class="col-md-8 col-md-offset-2 value-proposition">
        <h1 id="sell"><big><?php echo __d('landing1', 'Averigua precios de choferes privados en %s', '<code><b><big>Cuba</big></b></code>') ?></big></h1>
        <br/>
        <h2>
            <b><?php echo __d('landing1', 'Te conectamos con %s choferes independientes que viven en Cuba para que acuerdes precios directamente con ellos', __('varios')) ?></b>
        </h2>
        <br/>
        <h3>
            <?php echo __d('landing1', 'Conoce los precios para tus excursiones y traslados antes de llegar a la isla')?>
        </h3>
        <div class="sell-button" style="padding-top:30px">
            <a href="#!" class="btn btn-success show-travel-form">
                <?php echo __d('landing1', 'Sí, solicitar ofertas a choferes en Cuba') ?>
                <div class="sub">
                    <?php echo __d('landing1', 'Contrata un chofer si así lo decides') ?>
                </div>
            </a>
        </div>
    </div>
...
<div class="featurette-container arrow_box arrow_box_bottom">
    ...
    <div class="row featurette">
        ...
        <div class="col-md-7">
            ...
            <br/>
            <br/>
            <p class="lead"><?php echo __d('landing1', 'El chofer con quien viajas es importante y hace la diferencia. Nuestros choferes son pilotos, pescadores, comediantes, todos propietarios de un auto que nos ayudan a moverte por la isla. Conecta con tu chofer de la manera que prefieras.') ?></p>
            <p><?php echo $this->Html->link('<big><big>'.__d('landing1', 'Mira fotos y testimonios sobre nuestros choferes').' »</big></big>', array('controller'=>'testimonials', 'action'=>'featured', '?'=>array('also'=>Configure::read('Config.language') == 'es'?'en':'es')), array('class'=>'btn btn-warning', 'escape'=>false))?></p>
        </div>
    </div>
    ...
    <div class="row">
        <div id="TravelRequest" style="margin-top: 25px;padding: 15px;padding-top: 25px;">
            <div style="text-align:center;margin-bottom: 30px">
                <div class="handwritten-2"><big><big><b><?php echo __d('landing1', 'Haz un viaje sorprendente con tu chofer en Cuba') ?></b></big></big></div>
                <div><big><?php echo __d('landing1', 'Envía tu solicitud a varios choferes y <b>recibe ofertas directamente de ellos</b>') ?></big></div>
            </div>
