            ...
            <?php echo $this->Session->flash('auth'); ?>
                <div id="content" class="container">
                    <!--<div class="row" style="margin-top: 5em">                
                        <div class='alert alert-info alert-dismissable col-md-9' style="text-align: center"><button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button>
