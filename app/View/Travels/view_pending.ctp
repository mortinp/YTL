    ...
    <div class="row">
        ...
        <div class="col-md-8 col-md-offset-2">
            ...
            <fieldset>
                ...
                echo '<div style="max-width:350px">'.$this->Form->input('password', array('label'=> __d('pending_travel', 'Crea una contraseña para tu cuenta'), 'placeholder'=>__d('pending_travel', 'Escribe la contraseña que usarás para YoTeLlevo'), 'autofocus')).'</div>';
