<div>
    ...
    <div>
        <b>Choferes bloqueados por provincias:</b>
        <?php
        $results = array();
...
<table class='table table-striped table-hover'>
    <thead><th></th><th>ID</th><th>Código</th><th>Correo</th><th>PAX</th><th>Moderno</th><th>A/C</th><th>Inglés</th><th>Descripción</th><th>Provincia</th><th>Localidades</th><th>Operador</th><th>Fecha BLOQUEO</th><th>Token</th></thead>
    <tbody> 
    <?php foreach ($drivers as $d): ?>
        ...
        <tr class="<?php if(!$d['Driver']['active']) echo "danger";else if(!$d['Driver']['receive_requests']) echo "info"?>">
            ...
            <td><?php echo $d['Driver']['date_blocked']?></td>
