...
<?php if($profile['Driver']['for_tours']): ?>
    <section class="mbr-gallery mbr-slider-carousel cid-rShf8Fn4fO" id="gallery1-4l">

    
    <div class="container align-center">
        <h2 class="pb-3 mbr-fonts-style mbr-section-title display-2">He offers tours around Havana</h2>
        <h3 class="pb-5 mbr-section-subtitle mbr-fonts-style mbr-light display-5">See what you can do with <?php echo $driver_short_name ?>...</h3>
    </div>
    <div class="container">
