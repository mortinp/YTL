    ...
    <div class="container">
        <div class="row justify-content-md-center">
            <div class="col-md-10 align-center">
                ...
                <p class="mbr-text pb-3 mbr-fonts-style display-5"><?php echo __d('mobirise/drivers_by_province', 'Taxi a tiempo completo - Recogida en aeropuerto de %s - Tour por toda Cuba - Tour de un día a Viñales - Traslados desde %s a cualquier destino',array($province['name'],$province['name'])); ?>
                    <br><br>
                ...
                <div class="user row">
                    <div class="col-lg-3 col-md-4">
                        <div class="user_image">
                            <img class="img-responsive" src="<?php echo $driver['drivers_profiles']['featured_img_url']?>" alt="" title="">
                        </div>                        
                    </div>
                    ...
                    <div class="col-lg-6 col-md-4" style="padding-top: 30px">
                        <?php $hasReview = $driver['testimonials']['review_count'] != null;?>
                                <?php if($hasReview):?>
                        <p class="text-muted"><span class="fa fa-comments-o"></span> <?php echo __($driver['testimonials']['t_author']) ?>
                         <?php $hasCountry = $driver['testimonials']['author_country'] != null;?>
                                <?php if($hasCountry):?> de <?php echo $driver['testimonials']['author_country'] ?><?php endif; ?></p>
                        <i>"<?php echo $this->Text->truncate($driver['testimonials']['t_body'],250) ?>"</i>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
