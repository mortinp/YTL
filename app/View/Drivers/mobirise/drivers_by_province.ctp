...
<section class="testimonials4 cid-rsmhu3OqyL" id="testimonials4-3c">
  ...
  <div class="container">
    ...
    <h3 class="mbr-section-subtitle mbr-light pb-3 mbr-fonts-style mbr-white align-center display-5">These drivers are availabe for hiring for your trips in Cuba starting in Havana.<br>You can ask them directly for quotes right away from their profiles.<br>
    </h3>
