...
<p>
    <a  style="padding:10px;color: #333;background-color: #ebebeb;border-color: #adadad;text-decoration: none"
        href="<?php  echo $this->Html->url(array('controller'=>'drivers','action'=>'messages', $driver_travel['id'], 'base'=>false), true);?>"
        target="_blank"><b>Mira la conversación completa en nuestro sitio Web »</b>
    </a>
</p>
