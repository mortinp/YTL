...
class AppController extends Controller {
    ...
    private function _getPageTitle($key) {
        $pageTitles = array(
            'default' =>array('title'=>__d('meta', 'Contrata taxi con chofer en Cuba: La Habana, Varadero, Viñales, Trinidad, Santiago de Cuba y más'), 'description'=>__d('meta', 'Descubre choferes que operan en Cuba, recibe ofertas de precio directamente de ellos y contrata al mejor para tu viaje.')),
