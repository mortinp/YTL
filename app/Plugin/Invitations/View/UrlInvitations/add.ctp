<div class="row">
    <div class="col-md-6 col-md-offset-3">
        ...
        <div>
            ...
            <fieldset>
                <?php
                echo $this->Form->input('url', array('label'=>'Url <span class="small">ej. /metrics/dashboard</span>', 'type'=>'text'));
                ...
                echo $this->Form->input('message_to_invitee', array('label'=>'Mensaje (ej. Hola invitado)'));
