...
<br/>
<div><?php echo $this->Html->link(__d('shared_travels', 'Solicitar este transfer'), array('action'=>'create?s='.$code.'#request-ride'), array('class'=>'btn btn-block btn-info', 'target'=>'_blank'))?></div>